...
const SearchNav = () => {
  ...
  useEffect(() => {
    ...
    return (
        <div className="flex items-center justify-between w-full mt-[-30px] z-10 flex w-full h-20   backdrop-blur-[1px] bg-black/2 p-3 ">
            <div onClick={() => navigate(`/Smtv/${username}`)}>
                ...
                <div className="relative flex justify-center items-center w-[50%] mx-10 gap-2 border border-[0.5px] border-gray-900 rounded-xl backdrop-blur-sm bg-black/2 rounded-xl">
                    <input
            ...
            <div className="flex items-center justify-center gap-5">
                <p onClick={() => navigate(`/Smtv/${username}/favorite`)}>Favorite</p>
                <div
                    className="flex w-full justify-center ml-2 gap-2 items-center"
                    onClick={() => navigate(`/Smtv/profile/${username}`)}
                >
                    <p className="sm:hidden lg:block">{LoggedUser}</p>
                    <img
                        className="h-6 w-6 lg:h-8 lg:w-8 sm:w-6 rounded-[50%]"
